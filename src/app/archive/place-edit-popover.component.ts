      ...
      <div class="local-glass-island">
        ...
        <div class="form-container">
          ...
          <div class="input-group">
            ...
            <ion-textarea
              [(ngModel)]="editablePlace.description"
              rows="2"
              autoGrow="true"
              class="custom-textarea"
            ></ion-textarea>
          ...
          <div class="input-group">
            ...
            <div class="categories-grid">
              ...
              >
                <ion-icon
                  [name]="cat.icon"
                  [color]="isCategorySelected(cat.id) ? 'white' : cat.color"
                ></ion-icon>
                <span>{{
                  'CATEGORIES.' + cat.id.toUpperCase() | translate
                }}</span>
              </div>
              }
            </div>
...
export class PlaceEditPopover implements OnInit {
  ...
  ngOnInit() {
    ...
    if (
      !this.editablePlace.categories ||
      this.editablePlace.categories.length === 0
    ) {
