  ...
  template: `
    <ion-content scrollY="false" class="ion-no-padding">
      <div class="local-glass-island">
        ...
        <div
          class="photo-preview-container ion-activatable"
          (click)="openPhotoViewer()"
        >
          <img
            [src]="getWebUrl(editableWpt.photos[0])"
            class="waypoint-photo"
            loading="lazy"
          />
        ...
        <div class="meta-tags-row">
          @if (editableWpt.altitude !== undefined && editableWpt.altitude !==
          null) {
          <span class="meta-tag">
...
export class WptPopoverComponent implements OnInit {
  ...
  public confirm() {
    this.popoverCtrl.dismiss({ action: 'ok', ...this.editableWpt });
  }
